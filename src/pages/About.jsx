        ...
        <div className="mt-[50px] w-11/12 max-w-maxContent mx-auto text-white">
            ...
            <section>
                <div className="">
                    ...
                    <p className="text-lg text-center w-[70%] mx-auto mt-3 text-richblack-200">M&S is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
